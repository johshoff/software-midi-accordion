A quick hack to be able to practice accordion while travelling. It runs in the terminal and creates a virtual MIDI-instrument that you can use for example Garageband.
